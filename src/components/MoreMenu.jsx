...
import {
  FileText, Users, CreditCard, Settings as SettingsIcon, X,
  Map, Package, CheckSquare, BarChart3
} from 'lucide-react'
...
export default function MoreMenu({ onClose }) {
  return (
    <div className="fixed inset-0 z-50 md:hidden">
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-base-900 border-t border-base-700 rounded-t-2xl p-4 max-h-[70vh] overflow-y-auto">
