...
import {
  ...
  Users, CreditCard, Settings as SettingsIcon, X, Map,
  Package, CheckSquare, BarChart3
} from 'lucide-react'
...
const navItems = [
  ...
  { to: '/itineraries', label: 'Itineraries', icon: Map, countKey: 'bookings' },
  { to: '/customers', label: 'Customers', icon: Users, countKey: 'customers' },
  { to: '/packages', label: 'Packages', icon: Package, countKey: 'packages' },
  { to: '/tasks', label: 'Tasks', icon: CheckSquare, countKey: 'tasks' },
...
export default function Sidebar({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      >
        <div className="flex items-center justify-between px-4 h-16 border-b border-base-700 shrink-0">
          <Logo />
